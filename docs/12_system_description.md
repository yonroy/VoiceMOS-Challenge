...
| **🚀 exp18 CROSS-ATTENTION (DEV NỘP, 16/6/2026)** | — (fallback) | **0.8144** 🏆 | 0.1351 | 0.6403 / 0.7917 / 0.7426 |
...
> 🚀 **exp18 (16/6, NỘP) — KỶ LỤC EMOS 0.8144:** cross-attention fusion WavLM(SAILER) ⟷ audeering (CẢ HAI đóng băng + cache frame-level, chỉ train fusion+heads ~1.7M tham số) → EMOS **0.8144** 🏆 (vượt exp08b 0.8116). Các cột còn lại (CAT 0.1351 · VAL 0.6403 · ARO 0.7917 · DOM 0.7426) KHÔNG vượt best. Ý nghĩa: **frozen + cross-attn ≈ exp08 fine-tune mà rẻ hơn nhiều** → đóng góp "hiệu quả/chi phí" (C5) cho paper. Code: `kaggle_baseline/track2/exp18_crossattn_emotion_pipeline.py`.
