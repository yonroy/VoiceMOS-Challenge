...
> Nguồn: trang mô tả các track + Submission guideline trên CodaBench (lưu tại `Content VMos 2026/`). Cập nhật: 1/6/2026.
...
| **Lấy data** | Tự do (HuggingFace) | License form → Erica Cooper | License form → Erica Cooper |
